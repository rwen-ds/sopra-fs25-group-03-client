      ...
      <section className="hero min-h-[calc(100vh-4rem)]">
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 p-10 w-full">
          ...
          <div className="max-w-3xl flex items-center">
            <h2 className="text-4xl font-semibold text-primary-content mb-4 leading-relaxed">
          ...
          <div className="flex flex-col items-center justify-center gap-10 p-10">
            <div className="relative rounded-box overflow-hidden w-full h-[350px]">
              <Image
                src="/cat.jpg"
                alt="Cat"
                fill
            ...
            <div className="max-w-xl text-lg leading-relaxed text-gray-400">
              <p>
